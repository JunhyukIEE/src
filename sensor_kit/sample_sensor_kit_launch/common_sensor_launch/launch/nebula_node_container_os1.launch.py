...
def launch_setup(context, *args, **kwargs):
    ...
    #     )
    # )
    # 260328 LJH - remove nebula_ros driver to use os1_ros driver, which is more mature and supports more features for Ouster OS1 lidar
    ...
    #     )
    # )
    # 260328 LJH - remove ring outlier filter
